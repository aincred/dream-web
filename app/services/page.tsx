                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {category.services.map((service, i) => {
                    ...
                    return (
                      ...
                      >
                        <ServiceIcon className="w-5 h-5 text-indigo-500 dark:text-indigo-400 group-hover:scale-110 transition-transform" />
                        <span className="text-gray-800 dark:text-gray-200 font-medium group-hover:text-indigo-500 dark:group-hover:text-indigo-400">
                          {service.title}
                        </span>
                      </motion.a>
                    )
